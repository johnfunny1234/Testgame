...
- Upgrading to Large Cameraman costs 25 score after TV Man and returns you to a heavy-duty flash/punch kit with a longer beam reach and a beefy heart pool.
- Upgrading to Large Speakerman costs 35 score after TV Man (use key **I**) and grants the biggest health pool, the strongest punches, an **ultra sound blast** on F that chunks and launches crowds, and a **kicking smash** on X that deletes normals in two hits and Mediums in one.
